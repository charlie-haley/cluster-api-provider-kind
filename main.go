...
import (
	...
	infrastructurev1alpha1 "github.com/charlie-haley/cluster-api-provider-kind/api/v1alpha1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f75e3c51.cluster.x-k8s.io",
